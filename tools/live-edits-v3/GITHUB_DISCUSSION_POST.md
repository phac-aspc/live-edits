...
- 🎯 **Dual-Mode Editing** - Selective editing (`.editable` only) or default mode (everything editable except `.non-editable`)
- 💾 **Smart Saving** - Element-by-element saving preserves interactive elements, scripts, and event listeners
- 👥 **Real-time Collaboration** - Multiple users can edit simultaneously
- 💬 **Comment System** - Click-to-place comments for feedback
- 👀 **Presence Indicators** - See who's currently active on a page
- 📝 **Edit History** - Track all changes over time with revert functionality
...
**https://github.com/phac-aspc/live-edits**
...
**Selective Mode (Recommended for most cases):**
Add `class="editable"` to elements you want to make editable:
...
If no `.editable` elements are found, everything becomes editable except elements marked with `class="non-editable"`:
...
The editor automatically detects which mode to use based on whether `.editable` elements exist on the page.

### 4. Publishing Edits Back to Original Folder
...
- **Dual-Mode Editing** - Choose between selective (`.editable` only) or default (everything except `.non-editable`) editing modes
- **Smart Content Preservation** - Element-by-element saving preserves interactive elements, scripts, and event listeners - no rehydration needed!
...
- **Backward Compatible** - Works with existing edits saved in the old format

## 📖 Additional Resources

- **C9 Documentation** - Full documentation and detailed guides
- **GitHub Repository** - https://github.com/phac-aspc/live-edits
